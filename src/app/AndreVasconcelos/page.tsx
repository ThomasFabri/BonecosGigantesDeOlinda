        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  André Vasconcelos é um renomado artista plástico e mestre bonequeiro de Olinda, Pernambuco. Ele esta envolvido com a magia do Carnaval de Olinda desde a infância, tornando-se uma figura central na preservação e inovação da arte dos Bonecos Gigantes.
                </p>
              </div>
          ...
          <section className="mb-12">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div>
                <h3 className="text-3xl font-bold text-gray-800 mb-4">Acervo de Andre</h3>
                <p className="text-gray-700 leading-relaxed">
